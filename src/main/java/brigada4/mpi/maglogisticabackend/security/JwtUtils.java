...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        userPrincipal.getAuthorities().forEach(role -> roles.append(role.getAuthority()).append(" "));

        return Jwts.builder().setSubject((userPrincipal.getUsername())).setIssuer(roles.toString())
